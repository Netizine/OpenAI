...
namespace OpenAI.Infrastructure
{
    ...
    /// </summary>
    public class OpenAIObjectConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            throw new NotSupportedException("OpenAIObjectConverter should only be used while deserializing.");
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            Type concreteType = OpenAITypeRegistry.GetConcreteType(objectType, objectValue);
